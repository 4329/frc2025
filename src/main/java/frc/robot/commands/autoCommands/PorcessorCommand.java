...
import frc.robot.subsystems.differentialArm.DifferentialArmImpl;
...
public class PorcessorCommand extends LoggedSequentialCommandGroup {
    ...
    public PorcessorCommand(ElevatorSubsystem elevatorSubsystem, DifferentialArmSubsystem differentialArmSubsystem, AlgeePivotSubsystem algeePivotSubsystem, AlgeeWheelSubsystem algeeWheelSubsystem) {
        ...
        addCommands(
            ...
            ).onlyIfLog(() -> differentialArmSubsystem.getPitchSetpoint() != DifferentialArmPitch.NINETY.getRotation() && differentialArmSubsystem.pitchAtSetpoint()),
