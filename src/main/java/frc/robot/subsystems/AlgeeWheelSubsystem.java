...
public class AlgeeWheelSubsystem extends SubsystemBase {
	...
	GenericEntry running = Shuffleboard.getTab("RobotData").add("AlgeeWheelRunning", false).withPosition(4, 2).withSize(3, 2).withProperties(Map.of("Color when true", "#00FF00", "Color when false", "#000000")).getEntry();
