	...
	public AutoScoreCoralButCool(
		...
		addCommands(
				new LoggedParallelCommandGroup(
					"Setup and minDist",
					new CenterInAutoCommand(poseEstimationSubsystem, drivetrain, num, right, 1 /*change WIP*/),
					new LoggedSequentialCommandGroup(
						...
						new CenterInAutoCommand(poseEstimationSubsystem, drivetrain, num, right, DifferentialArmSubsystem.ARM_LENGTH_CORAL_CENTER)
							new SetArmPitchCommand(
