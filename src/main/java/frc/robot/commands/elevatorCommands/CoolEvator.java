...
public class CoolEvator extends Command {
	...
	public void initialize() {
		...
		new SetElevatorCommand(elevatorSubsystem, ElevatorPosition.values()[(int)(yep.getDouble(0) * 2)]).schedule();
	}
	...
	public void end(boolean interrupted) {
		new SetElevatorCommand(elevatorSubsystem, ElevatorPosition.values()[(int)(yep.getDouble(0) * 2 + 1)]).schedule();
	}
