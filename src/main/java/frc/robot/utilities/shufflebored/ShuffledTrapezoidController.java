...
public class ShuffledTrapezoidController extends ProfiledPIDController {
    ...
    public ShuffledTrapezoidController(double p, double i, double d, TrapezoidProfile.Constraints constraints) {
	...
	public void initSendable(SendableBuilder builder) {
		...
		builder.addDoubleProperty("speed", () -> getConstraints().maxVelocity, x -> setConstraints(new TrapezoidProfile.Constraints(x, getConstraints().maxAcceleration)));
		builder.addDoubleProperty("accel", () -> getConstraints().maxAcceleration, x -> setConstraints(new TrapezoidProfile.Constraints(getConstraints().maxAcceleration, x)));
	}
}
