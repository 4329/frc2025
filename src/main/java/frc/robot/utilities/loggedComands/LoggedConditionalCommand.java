 ...
 */
public class LoggedConditionalCommand extends LoggedCommandComposer {
  ...
  public LoggedConditionalCommand(Command onTrue, Command onFalse, BooleanSupplier condition) {
