...
public class ClimberSubsystem extends SubsystemBase implements LoggedSubsystem {
    ...
    public ClimberSubsystem() {
        ...
        config = new SparkMaxConfig().apply(new SoftLimitConfig().forwardSoftLimit(MAX).forwardSoftLimitEnabled(true).reverseSoftLimit(MIN).reverseSoftLimitEnabled(true));
